...
function generator(adj, noun) {
  ...
  var adjectives = getAdj(adj),
      nouns = getNoun(noun),
      randomAdjective = parseInt(Math.random() * adjectives.length, 10),
      randomNoun = parseInt(Math.random() * nouns.length, 10),
...
function randomName() {
  ...
  var randomNumberAdj = parseInt(Math.random() * adjectives.length, 10),
      randomNumberNoun = parseInt(Math.random() * nouns.length, 10);
...
// used object format to organize methods for the pizza slider instead of exposing all functions to the global namespace
...
var changeSize = {
  ...
  determineDx: function (elem, size) {
    'use strict';
  ...
  changePizzaSizes: function (size) {
    'use strict';
      var pizzaContainer = document.getElementsByClassName("randomPizzaContainer"),
          dx = this.determineDx(pizzaContainer[0], size),
  ...
  resizePizzas: function (size) {
    'use strict';
      ...
      this.changeSliderLabel(size);
      this.changePizzaSizes(size);
